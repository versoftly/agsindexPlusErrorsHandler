                ...
                '   <h2>Peticiones a la api , el orden de las variables que
                    ...
                    <table>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td data-title="Columna 1">
                            Busqueda de una palabra en una columna
                          </td>
                          <td data-title="Columna 2">
                            <i>Muestrame los resultados que contengan la palabra
                            Samsung.</i>
                          </td>
                          <td data-title="Columna 3">
                              <a href="https://database2.adaptowebs.com/products?select=*&key=name_product&search=Samsung">
                              <i>https://database2.adaptowebs.com/products?select=*&key=name_product&search=Samsung</i>
                              </a>
                          </td>
                        </tr>
                        ...
                        <tr>
                          <td data-title="Columna 1">
                            Busqueda de una palabra en una columna con filtro
                          </td>
                          <td data-title="Columna 2">
                            <i>Muestrame los resultados que contengan la palabra
                            Sound that are under the category 3.</i>
                          </td>
                          <td data-title="Columna 3">
                              <a href="https://database2.adaptowebs.com/products?select=*&key=name_product|id_category_product&search=Sound|3">
                              <i>https://database2.adaptowebs.com/products?select=*&key=name_product|id_category_product&search=Sound|3</i>
                              </a>
                          </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td data-title="Columna 2">
                            <i>Muestrame los resultados que contengan la palabra
                            Sound that are under the category 3 y la informacion de la
                            categoria.</i>
                          </td>
                          <td data-title="Columna 3">
                              <a href="https://database2.adaptowebs.com/relations?rel=products|categories&type=product|category&select=*&key=name_product|id_category_product&search=Sound|3">
                              <i>https://database2.adaptowebs.com/relations?rel=products|categories&type=product|category&select=*&key=name_product|id_category_product&search=Sound|3</i>
                              </a>
                          </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td data-title="Columna 2">
                            <i>Muestrame el nombre del producto y la categoria
                            donde haya coincidencias con la palabra Sound.</i>
                          </td>
                          <td data-title="Columna 3">
                              <a href="https://database2.adaptowebs.com/relations?rel=products|categories&type=product|category&select=name_product,name_category&key=name_product|id_category_product&search=Sound|3">
                              <i>https://database2.adaptowebs.com/relations?rel=products|categories&type=product|category&select=name_product,name_category&key=name_product|id_category_product&search=Sound|3</i>
                              </a>
                          </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td data-title="Columna 2">
                            <i>Muestrame todos los productos creados entre
                            la fecha 2021-07-19 y 2021-09-19.</i>
                          </td>
                          <td data-title="Columna 3">
                              <a href="https://database2.adaptowebs.com/products?select=*&betweenstart=2021-07-19&betweenend=2021-09-19&key=date_created_product">
                              <i>https://database2.adaptowebs.com/products?select=*&betweenstart=2021-07-19&betweenend=2021-09-19&key=date_created_product</i>
                              </a>
                          </td>
                        </tr>
                        ...
                        <tr>
                          <td data-title="Columna 1">
                            Rangos con filtro. ( no te olvides de 
                            utilizar \',\' en vez de \'|\' para el filtro con rangos ).
                          </td>
                          <td data-title="Columna 2">
                            <i>Muestrame todos los productos creados entre
                            la fecha 2021-07-19 y 2021-09-19 y que pertenescan
                            alas categorias 1 y 2.</i>
                          </td>
                          <td data-title="Columna 3">
                              <a href="https://database2.adaptowebs.com/products?select=*&betweenstart=2021-07-19&betweenend=2021-09-19&key=date_created_product&filter=id_category_product&in=1,2">
                              <i>https://database2.adaptowebs.com/products?select=*&betweenstart=2021-07-19&betweenend=2021-09-19&key=date_created_product&filter=id_category_product&in=1,2</i>
                              </a>
                          </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td data-title="Columna 3">
                              <a href="https://database2.adaptowebs.com/relations?rel=products|categories&type=product|category&key=date_created_product&betweenstart=2021-07-19&betweenend=2021-09-19&select=*&filter=id_category_product&in=1">
                              <i>https://database2.adaptowebs.com/relations?rel=products|categories&type=product|category&key=date_created_product&betweenstart=2021-07-19&betweenend=2021-09-19&select=*&filter=id_category_product&in=1</i>
                              </a>
                          </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td data-title="Columna 2">
                            <i>Muestrame los campos name_product,name_category y date_created_product
                            de todos los productos creados entre
                            la fecha 2021-07-19 y 2021-09-19 y que pertenescan
                            alas categorias 1.</i>
                          </td>
                          <td data-title="Columna 3">
                              <a href="https://database2.adaptowebs.com/relations?rel=products|categories&type=product|category&key=date_created_product&betweenstart=2021-07-19&betweenend=2021-09-19&select=name_product,name_category,date_created_product&filter=id_category_product&in=1">
                              <i>https://database2.adaptowebs.com/relations?rel=products|categories&type=product|category&key=date_created_product&betweenstart=2021-07-19&betweenend=2021-09-19&select=name_product,name_category,date_created_product&filter=id_category_product&in=1</i>
                              </a>
                          </td>
                        </tr>
                      </tbody>
